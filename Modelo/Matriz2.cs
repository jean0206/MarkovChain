...
namespace Modelo
{
    public class Matriz2
    {
        ...
        public double[,] matrizValues() {
            double[,] resultado;
            StreamReader reader = new StreamReader("matrizPromedio2.csv");
            StreamReader reader1 = new StreamReader("matrizPromedio2.csv");
            string line;
            String[] ini = reader1.ReadLine().Split(';');
            resultado = new double[ini.GetLength(0), ini.GetLength(0)];
            int i = 0;
        ...
        public string[,] matrixCombinatory()
        {
            string[,] resultado;
            StreamReader reader = new StreamReader("ProbMatriz.csv");
            StreamReader reader1 = new StreamReader("ProbMatriz.csv");
            string line;
            String[] ini = reader1.ReadLine().Split(';');
            resultado = new string[9,8];
            int i = 0;
